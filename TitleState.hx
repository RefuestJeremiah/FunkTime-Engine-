	...
	override function beatHit()
	{
		...
		if(!closedState) {
			...
			switch (sickBeats)
			{
				...
				case 2:
					#if PSYCH_WATERMARKS
					createCoolText(['FunkTime Engine by'], 15);
					#else
				...
				case 4:
					#if PSYCH_WATERMARKS
					addMoreText('RefuestJeremiah/SpadeArcade', 15);
					addMoreText('Psych Engine Team', 15);
					addMoreText('Supports', 15);
					addMoreText('Sweet Nightmare Mod Team', 15);
					addMoreText('Sweetie Sky High Adventure, The Contractor, , 15);
					#else
					addMoreText('present');
					#end
				// credTextShit.text += '\npresent...';
				...
				case 17:
					addMoreText('FunkTime Engine);  // credTextShit.text += '\nFunkTime Engine';
